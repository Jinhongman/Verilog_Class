...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net microblaze_0_Byte_Enable [get_bd_pins ahblite_axi_bridge_0/s_ahb_hready_in] [get_bd_pins microblaze_0/Byte_Enable]
  ...
  connect_bd_net -net microblaze_0_D_AS [get_bd_pins ahblite_axi_bridge_0/s_ahb_hprot] [get_bd_pins microblaze_0/D_AS]
  connect_bd_net -net microblaze_0_Data_Addr [get_bd_pins ahblite_axi_bridge_0/s_ahb_haddr] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hsize] [get_bd_pins microblaze_0/DWait] [get_bd_pins microblaze_0/Data_Addr] [get_bd_pins microblaze_0/Data_Read]
