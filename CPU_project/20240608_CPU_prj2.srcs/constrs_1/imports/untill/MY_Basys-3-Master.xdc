...
set_property -dict { PACKAGE_PIN W15  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[0]  }]; #IO_L21N_T3_DQS_A06_D22_14  ,Sch=SW4
set_property -dict { PACKAGE_PIN V15  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[1]  }]; #IO_L21P_T3_DQS_14          ,Sch=SW5
set_property -dict { PACKAGE_PIN W14  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[2]  }]; #IO_L22N_T3_A04_D20_14      ,Sch=SW6
set_property -dict { PACKAGE_PIN W13  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[3]  }]; #IO_L22P_T3_A05_D21_14      ,Sch=SW7
#set_property -dict { PACKAGE_PIN V2   IOSTANDARD LVCMOS33 } [get_ports { IOPortB[8]  }]; #IO_L5P_T0_34               ,Sch=SW8
...
set_property -dict { PACKAGE_PIN W2   IOSTANDARD LVCMOS33 } [get_ports { inPort[3] }]; #IO_L5N_T0_34               ,Sch=SW12
set_property -dict { PACKAGE_PIN U1   IOSTANDARD LVCMOS33 } [get_ports { inPort[2] }]; #IO_L3N_T0_DQS_34           ,Sch=SW13
set_property -dict { PACKAGE_PIN T1   IOSTANDARD LVCMOS33 } [get_ports { inPort[1] }]; #IO_L3P_T0_DQS_34           ,Sch=SW14
set_property -dict { PACKAGE_PIN R2   IOSTANDARD LVCMOS33 } [get_ports { inPort[0] }]; #IO_L1P_T0_34               ,Sch=SW15


## LEDs

set_property -dict { PACKAGE_PIN U16  IOSTANDARD LVCMOS33 } [get_ports { IOPortC[0]  }]; #IO_L23N_T3_A02_D18_14        ,Sch=LED0
set_property -dict { PACKAGE_PIN E19  IOSTANDARD LVCMOS33 } [get_ports { IOPortC[1]  }]; #IO_L3N_T0_DQS_EMCCLK_14      ,Sch=LED1
set_property -dict { PACKAGE_PIN U19  IOSTANDARD LVCMOS33 } [get_ports { IOPortC[2]  }]; #IO_L15P_T2_DQS_RDWR_B_14     ,Sch=LED2
set_property -dict { PACKAGE_PIN V19  IOSTANDARD LVCMOS33 } [get_ports { IOPortC[3]  }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 ,Sch=LED3
set_property -dict { PACKAGE_PIN W18  IOSTANDARD LVCMOS33 } [get_ports { IOPortD[0]  }]; #IO_L16P_T2_CSI_B_14          ,Sch=LED4
set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 } [get_ports { IOPortD[1]  }]; #IO_L23P_T3_A03_D19_14        ,Sch=LED5
set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 } [get_ports { IOPortD[2]  }]; #IO_25_14                     ,Sch=LED6
set_property -dict { PACKAGE_PIN V14  IOSTANDARD LVCMOS33 } [get_ports { IOPortD[3]  }]; #IO_L24N_T3_A00_D16_14        ,Sch=LED7
#set_property -dict { PACKAGE_PIN V13  IOSTANDARD LVCMOS33 } [get_ports { IOPortB[4]  }]; #IO_L24P_T3_A01_D17_14        ,Sch=LED8
...
set_property -dict { PACKAGE_PIN P3   IOSTANDARD LVCMOS33 } [get_ports { outPort[0] }]; #IO_L12N_T1_MRCC_35           ,Sch=LED12
set_property -dict { PACKAGE_PIN N3   IOSTANDARD LVCMOS33 } [get_ports { outPort[1] }]; #IO_L12P_T1_MRCC_35           ,Sch=LED13
set_property -dict { PACKAGE_PIN P1   IOSTANDARD LVCMOS33 } [get_ports { outPort[2] }]; #IO_L19N_T3_VREF_35           ,Sch=LED14
set_property -dict { PACKAGE_PIN L1   IOSTANDARD LVCMOS33 } [get_ports { outPort[3] }]; #IO_L6N_T0_VREF_35            ,Sch=LED15
